...
Thus Audit 3 remains blocked on a source spectrum, and Audit 2 remains blocked
on physical flavor rotations, but no longer on the source-basis symbolic
triplet-inverse entries.
