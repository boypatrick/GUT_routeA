...
hand-audit adjugate/cofactor contract for a symbolic inverse.  These are smoke
gates, not a completed source audit: scalar-Hessian Goldstone eigenvectors, a
CAS-expanded symbolic triplet inverse, and a non-placeholder heavy spectrum
remain pending.  Thus Audit 3 remains blocked on a source spectrum, and Audit
2 remains blocked on physical flavor rotations and on symbolic triplet inverse
entries.
