...
stage-1 scaffold in Pati--Salam blocks: it records the singlet-vev dictionary,
the \(D\)-flatness convention \(|\sigma|=|\bar\sigma|\), the unresolved
literature-cubic convention map, and the SU(5)/flipped-SU(5)/Pati--Salam
special-point acceptance gates.  It does not solve the F/D-flat vacuum or
