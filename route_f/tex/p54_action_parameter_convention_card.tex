...
After Pati--Salam and electroweak breaking, define $h=Y_{10}$,
$f=Y_{126}$ and the four bidoublet vacuum coordinates
$v_{10}^{u,d},v_{126}^{u,d}$.  The Clebsch convention is
\begin{align}
...
126&=(6,1,1)\oplus(10,3,1)\oplus(\overline{10},1,3)
 \oplus(15,2,2).
\end{align}
The neutral member of $(\overline{10},1,3)$ carries $\sigma$.  The $54$
keeps $D$ parity, so $g_L=g_R$ at the Pati--Salam matching scale in this
branch.
