...
\title{Route C Bootstrap Derivation Ledger through P7}
\author{BoYu Chen}
\date{\today}
...
\begin{abstract}
This note records the derivations generated in Route C stages P1--P7.
...
The P1--P7 chain currently establishes:
\begin{enumerate}
...
ledger.
\end{enumerate}
The next natural stage is P8: a candidate-theory comparison scorecard.  It
should compare $\SU(5)$, Pati--Salam, $\Spin(10)$, $E_6$, and
superstring-derived completions using the explicit P1--P7 gates, rather than
using anomaly cancellation or minimality alone.
