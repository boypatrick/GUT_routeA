...
\title{Route C Bootstrap Derivation Ledger through P6}
\author{BoYu Chen}
\date{\today}
...
\begin{abstract}
This note records the derivations generated in Route C stages P1--P6.
...
the first controlled high-energy-growth completion requirements.
\end{abstract}
...
The P1--P6 chain currently establishes:
\begin{enumerate}
...
\end{enumerate}
The next natural stage is P7: low-energy matching and proton-bound reporting.
It should use the P2/P3 symbolic pole components only after the P6 completion
status is respected, and it must mark all pre-flavor-audit Wilson
