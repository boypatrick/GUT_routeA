...
corroboration.  This note adds no phenomenology: the companion note's
deferred flavor, proton-decay, threshold, and source-sector audits are
untouched.
...
Those aliases are file-system labels, not scientific claims; outside this
remark and the literal file paths in Sec.~\ref{sec:manifest} they do not
occur in this paper.
\end{remark}
...
the stated kind.
\item[Deferred audits (unchanged from the companion note).]
Full flavor fit; \(d=5\) proton-decay Wilson tensors; threshold/proton
companion audits; source-sector UV origin; dependency graph
\(0\to(1\parallel4a)\to3\to2\), with 4b optional.
